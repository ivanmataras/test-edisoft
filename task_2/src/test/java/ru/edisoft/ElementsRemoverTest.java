...
public class ElementsRemoverTest {
    ...
    private List<Integer> numbersInARow = new ArrayList<Integer>(Arrays.asList(1, 2, 2, 2, 2, 3, 3, 3, 4, 5));
    ...
    public void testRemoveRepeatedInARow3OrMoreTimes() throws Exception {
        List<Integer> result = ElementsRemover.removeRepeatedInARowSequence(numbersInARow, 3);
